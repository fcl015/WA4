...
def summary_index():
    ...
    wa4_functions.read_data_file(area1)
    wa4_functions.read_data_file(area2)
    wa4_functions.read_data_file(area3)
    wa4_functions.read_data_file(area4)
    templateData=wa4_functions.getDataAllAreas(area1,area2,area3,area4) 
    return render_template('summary_index.html', **templateData)
...
def monitor_area1():
    ...
    wa4_functions.read_data_file(area1)      
    templateData=wa4_functions.getDataOneArea(area1) 
    return render_template('area1.html', **templateData)
...
def monitor_area2():
    ...
    wa4_functions.read_data_file(area2)   
    templateData=wa4_functions.getDataOneArea(area2) 
    return render_template('area2.html', **templateData)
...
def monitor_area3():
    ...
    wa4_functions.read_data_file(area3)      
    templateData=wa4_functions.getDataOneArea(area3) 
    return render_template('area3.html', **templateData)
...
def monitor_area4():
    ...
    wa4_functions.read_data_file(area4)      
    templateData=wa4_functions.getDataOneArea(area4) 
    return render_template('area4.html', **templateData)
...
def weather_index():
    ...
    wa4_functions.read_data_file(area1)   
    templateData=wa4_functions.getWeatherData(area1)
    return render_template('weather_index.html', **templateData)
...
@app.route("/data1/")
def data1():
    return send_file("../www/html/wa4_log/log_area1.csv", as_attachment=True)
...
@app.route("/data2/")
def data2():
    return send_file("../www/html/wa4_log/log_area2.csv", as_attachment=True)
...
@app.route("/data3/")
def data3():
    return send_file("../www/html/wa4_log/log_area3.csv", as_attachment=True)
...
@app.route("/data4/")
def data4():
    return send_file("../www/html/wa4_log/log_area4.csv", as_attachment=True)

#--------------------------------------------------------------------------------
# Acceso a Datos
#--------------------------------------------------------------------------------
@app.route("/thingspeak_index/")
def thingspeak_index():
    return render_template('thingspeak_index.html')
